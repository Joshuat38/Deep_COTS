...
VALID_LABELS_DIR = ROOT_DIR + '/5_fold_mixed_valid_annotations'
BASE_WIDTH = 1280
BASE_HEIGHT = 720
...
with open(f'{ROOT_DIR}/train_files_cots_5_fold_mixed.txt', 'w+') as txtFile:
    txtFile.writelines(train_lines)
with open(f'{ROOT_DIR}/valid_files_cots_5_fold_mixed.txt', 'w+') as txtFile:
