...
VALID_LABELS_DIR = ROOT_DIR + '/valid_annotations'
BASE_WIDTH = 1280
BASE_HEIGHT = 720
...
'''
train_metaData = pd.read_csv(SPLIT_DIR + '/train-0.2.csv')
...
with open(f'{ROOT_DIR}/train_files_cots.txt', 'w+') as txtFile:
    txtFile.writelines(train_lines)
with open(f'{ROOT_DIR}/valid_files_cots.txt', 'w+') as txtFile:
